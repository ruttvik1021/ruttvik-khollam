...
import { ArrowRight, ExternalLink, Facebook, Github, Instagram, Linkedin, Mail, MapPin, Phone, Twitter, X } from "lucide-react"
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      >
        <nav className="flex items-center justify-between">
          <Link href="#" className="flex items-center gap-2 text-xl font-bold font-cursive">
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                <DialogTitle className="font-cursive text-2xl">Contact Me</DialogTitle>
                <DialogDescription>
            ...
            >
              <Card className="bg-zinc-900/50 border-zinc-800 backdrop-blur-sm hover:bg-zinc-800/50 transition-colors">
                <CardContent className="p-6 text-center">
                  <div className={`w-16 h-16 mx-auto mb-4 rounded-xl ${skill.color} flex items-center justify-center`}>
                    <Image
                      src={skill.icon}
                      alt={skill.name}
                      width={40}
            ...
            <motion.div key={index} variants={fadeIn}>
              <Card className="bg-zinc-900 border-zinc-800 hover:bg-zinc-800/50 transition-colors">
                <CardContent className="pt-6">
                  <p className="text-primary mb-2 font-cursive">{experience.period}</p>
          ...
          <motion.div variants={fadeIn}>
            <Card className="bg-zinc-900 border-zinc-800 overflow-hidden group">
              ...
              <CardContent className="p-6">
                <h3 className="font-bold text-xl mb-2 font-cursive">Expense Tracker</h3>
                <p className="text-gray-400 mb-4">
                  A full-stack expense tracking application built with React, Node.js, and MongoDB.
                  Track your expenses, create budgets, and visualize your spending patterns.
                </p>
                <div className="flex gap-4">
                  <Button asChild>
                    <Link href="https://expense-tracker-ashy-beta.vercel.app/" target="_blank" className="gap-2">
          ...
          {[1, 2].map((item) => (
            <motion.div key={item} variants={fadeIn}>
              <Card className="bg-zinc-900 border-zinc-800 overflow-hidden group">
                ...
                <CardContent className="p-6">
                  <h3 className="font-bold text-xl mb-2 font-cursive">Project Title</h3>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h2 className="text-2xl font-bold font-cursive">Let's work together on your next project!</h2>
            </div>
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              <DialogTrigger asChild>
                <Button size="lg" variant="secondary">Contact Now</Button>
              </DialogTrigger>
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  <DialogTitle className="font-cursive text-2xl">Contact Me</DialogTitle>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="email-footer" type="email" placeholder="john@example.com" required />
                  </div>
                  <div  className="space-y-2">
                    <Label htmlFor="message-footer">Message</Label>
                    <Textarea id="message-footer" placeholder="Your message here..." required />
                  </div>
                  <Button type="submit" className="w-full">Send Message</Button>
                </form>
              </DialogContent>
      ...
      <footer className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-12">
          <div className="space-y-4">
            ...
            <p className="text-gray-400">Full Stack Web Developer specializing in modern web technologies.</p>
            <div className="flex gap-4">
